export const translations = {
    ...
    polish: {
        ...
        events: {
            ...
            events: [
                {
                    title: "Modlitwa Ramayan", description: "Hindusi odprawiają modlitwę Ramayan przed ślubem, aby prosić o błogosławieństwo dla silnego i harmonijnego małżeństwa. Historia o Ramie i Sicie symbolizuje miłość, wierność i obowiązek, prowadząc pary w ich małżeńskiej podróży.<br><br>Modlitwa przywołuje boską ochronę, promuje jedność rodziny, uczy odporności w małżeństwie i duchowo oczyszcza uroczystość, zapewniając pomyślny początek życia małżeńskiego.", time: "18 kwietnia - Rozpoczęcie o 10:00"
                },
