...
const Hero = () => {
	...
	return (
		<div className="h-screen w-full flex text-center align-top pt-[15vh] md:pt-[5vh]">
			<div
				className="absolute inset-0 bg-cover md:bg-cover bg-center bg-no-repeat flex bg-hero md:bg-hero-hoz"
			/>
